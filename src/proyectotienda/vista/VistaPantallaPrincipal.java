...
public class VistaPantallaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TIENDA LOU");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(320, 20, 340, 80);

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/wallpaper_store.jpg"))); // NOI18N
        fondo.setMaximumSize(new java.awt.Dimension(980, 700));
        fondo.setMinimumSize(new java.awt.Dimension(980, 700));
        fondo.setPreferredSize(new java.awt.Dimension(980, 700));
        getContentPane().add(fondo);
        fondo.setBounds(0, 0, 980, 700);
